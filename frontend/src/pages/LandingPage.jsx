...
const TAJ_LOGO = "/Assets/taj-logo.png";
        ...
        <section className="px-6 py-24 flex items-center justify-center">
          ...
          >
            ...
            <p
              ...
              style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}
            >
              In partnership with Taj, we bring world-class hospitality aesthetics into
        ...
        >
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              <img src={TAJ_LOGO} alt="Taj" className="h-6 brightness-0 invert opacity-60" />
              <span
